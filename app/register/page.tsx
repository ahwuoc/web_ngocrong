...
export default function RegisterPage() {
  ...
  return (
    <div id="register-page-premium" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black py-20 px-4">
